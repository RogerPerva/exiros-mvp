...
| [`openapi/openapi.yaml`](openapi/openapi.yaml) | **OpenAPI 3.0.3** (válido, carpeta propia `/openapi`) — puente para generar/alinear el front antes del backend. Autogenerado por NestJS cuando exista el código. |
